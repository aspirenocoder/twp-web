...
const Unicom = () => {
    ...
    return (
        <div className="flex w-full justify-center items-center bg-gradient-to-t from-[#0042A6] via-[#0064FF] to-[#0042A6] flex-col">
            ...
            <div style={{ backgroundImage: `url(${bgImage})`, backgroundSize: "cover", backgroundPosition: "center top 15px", backgroundRepeat: "no-repeat", height: '100%' }} className="relative z-50 w-[68%] flex justify-center items-center overflow-visible ">
