...
import bgImage from '../assets/aspire_line.png';
            ...
            <div className="flex w-full justify-center items-center bg-gradient-to-t from-[#0042A6] via-[#0064FF] to-[#0042A6] flex-col">
                ...
                <div style={{ backgroundImage: `url(${bgImage})`, backgroundSize: "cover", backgroundPosition: "center top 15px", backgroundRepeat: "no-repeat", height: "100%" }} className="relative z-50 w-[80%] flex justify-center items-center overflow-visible ">
                    ...
                    <div className="w-full">
                        <div className="w-1/2">
                            <p className="text-4xl text-[#FFED4E] font-bold">Aspire is NOW a Thriving Workplace!</p>
                            <p className="text-white mt-5">We are super thrilled to honor <span className="text-[#FFED4E] font-bold">Aspire</span> as a Thriving Workplace!</p>
                            <p className="text-white mt-5">Aspire has shown an extraordinary commitment to building a workplace where people feel valued, supported, and inspired.</p>
                            <p className="text-white">By focusing on the 10 Health Levers, Aspire demonstrates the perfect balance of compassionate leadership and organizational excellence, building an environment that values both its people and its culture.</p>
